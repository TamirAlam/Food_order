...
document.getElementById('orderButton').addEventListener('click', function(){
  ...
  foodImage.style.displayorder = 'none';
  orderIdValueElement.style.justifyContent='end';
  ...
  promise.then(function(){
      ...
      orderIdElement.style.display='flex';
      orderIdElement.style.justifyContent='center';
      orderIdElement.style.alignItems='center';
      orderIdElement.style.top="30%";
      orderIdElement.style.right="10%";
      orderIdElement.style.backgroundColor="aqua";
